...
### 프로그램 실행
![Image](https://github.com/user-attachments/assets/003ddf8a-ce4d-45ba-8872-ebc4c064e9ed)

---

## 🐛 에러 처리
- 입력 값이 숫자가 아니거나 음수일 경우, 경고 메시지가 출력됩니다.
- 잘못된 메뉴를 선택하면 "정신차리고 제대로 된 숫자 형태로 입금액을 작성해줘!!!" 메시지가 출력됩니다.
